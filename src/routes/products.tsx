...
function Products() {
  return (
    <Layout>
      ...
      <section id="beverages" className="py-20 mx-auto max-w-7xl px-4 lg:px-8 scroll-mt-52 md:scroll-mt-60">
      ...
      <section id="packaging" className="py-20 mx-auto max-w-7xl px-4 lg:px-8 scroll-mt-52 md:scroll-mt-60">
        <div className="text-center mb-12">
