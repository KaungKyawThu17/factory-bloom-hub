...
import productionBlowingImg from "@/assets/optimized/odm-mass-production-card.jpg";
...
import productionTunnelCoolingImg from "@/assets/optimized/production-tunnel-cooling-card.jpg";
